...
public class Task {
   ...
   */
   ...
   public class T{
       ...
       public int[] In_Address = {1,1}; //取快递地点
       public int[] Out_Time = {1,1,10,18}; //交接快递时间
   ...
   public void Initial(String example){
       ...
       if( str[1].equals("54") || str[1].equals("63") || str[1].equals("64") ) {
    	   str1(example); // 任务列表
       } else {
    	   str2(example); // 单个任务
       }
       ...
       for (int i = 2; i < str.length; i++) {
           ...
           case "20":
			...
			case "15":
                ...
                String address2 = cut(strr);
                if( address2.length() == 4 ) {
             	   this.Tasklist[Task_index].In_Address[0] = Integer.parseInt(address2.substring(0,2));
             	   this.Tasklist[Task_index].In_Address[1] = Integer.parseInt(address2.substring(2));
                }
                break;
			case "09":
                //交接快递时间
                String time2 = cut(strr);
                if( time2.length() == 8 ) {
             	   this.Tasklist[Task_index].Out_Time[0] = Integer.parseInt(time2.substring(0,2));
             	   this.Tasklist[Task_index].Out_Time[1] = Integer.parseInt(time2.substring(2,4));
             	   this.Tasklist[Task_index].Out_Time[2] = Integer.parseInt(time2.substring(4,6));
             	   this.Tasklist[Task_index].Out_Time[3] = Integer.parseInt(time2.substring(6,8));
                }
                break;
			case "08":
                //交接快递地址
                ...
                if( address3.length() == 4 ) {
             	   this.Tasklist[Task_index].Out_Address[0] = Integer.parseInt(address3.substring(0,2));
             	   this.Tasklist[Task_index].Out_Address[1] = Integer.parseInt(address3.substring(2));
                }
                break;
           }
       }
