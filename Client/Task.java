...
public class Task {
    ...
    String Usr2;//乙方用户
    int Usr2Id[];
    String TaskName;//任务标题
    String In_Address;//收货地址
    String CompanyName;//快递公司
    String Number;//快递单号（建议更改变量名）
    String ddl; //取快递的ddl
    String Out_Address;//收货地址
    String Out_Time;//收货时间
    String Usr1_TelephoneNumber;//手机号码，可能还需要乙方手机号
